  ...
  <section>
    <v-parallax height="600" class="temp-color">
      <v-layout column align-center justify-center class="white--text">
        <h1 class="white--text mb-2 display-1 text-xs-center">Welcome to
          <span class="highlight">Blokr.</span>
        </h1>
        <div class="subheading mb-3 text-xs-center">Making your time more modular</div>
        <v-btn dark large flat to="/SignUp">
          Get Started
        </v-btn>
      </v-layout>
    </v-parallax>
  ...
  <section>
    <v-parallax height="380" class="temp-color">
      <v-layout column align-center justify-center>
        ...
        <v-btn class="highlight" dark large flat>
          Get Started
        </v-btn>
      </v-layout>
    </v-parallax>
      ...
      <v-layout row wrap justify-center class="my-5">
        <v-flex xs12 sm4>
          <v-card class="elevation-0 transparent">
            ...
            <v-card-text>
              Cras facilisis mi vitae nunc lobortis pharetra. Nulla volutpat tincidunt ornare. Pellentesque habitant morbi tristique senectus
              et netus et malesuada fames ac turpis egestas. Nullam in aliquet odio. Aliquam eu est vitae tellus bibendum tincidunt.
              Suspendisse potenti.
            </v-card-text>
          </v-card>
        </v-flex>
